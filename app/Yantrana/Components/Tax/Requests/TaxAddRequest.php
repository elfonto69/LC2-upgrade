...
class TaxAddRequest extends BaseRequest
{
    ...
    *-----------------------------------------------------------------------*/
    ...
    {
        return [
            'applicable_tax.decimal_validation' => __('Digit after decimal may not be greater than __max__.', [
                    '__attribute__' => ':attribute',
                    '__max__'       => '4'
                ]),
            'applicable_tax.amount_validation' => __('The __attribute__ may not be greater than __max__.', [
                    '__attribute__' => ':attribute',
                    '__max__'       => '999999999'
                ]),
        ];
