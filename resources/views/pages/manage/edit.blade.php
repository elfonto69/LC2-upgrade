    ...
    <form class="lw-form lw-ng-form" 
        ...
        <div ng-if="editPageCtrl.pageData.type != 3">
    		...
    		<div class="form-inline">
    			...
    			<!-- Active -->
    	        <lw-form-checkbox-field ng-if="editPageCtrl.pageData.id !== 1" field-for="active" label="<?= __( 'Active' ) ?>" advance="true">
    	            <input type="checkbox" 
    	        ...
    	        <!-- Hide Sidebar -->
    	        <lw-form-checkbox-field ng-if="editPageCtrl.pageData.type == 1" field-for="hide_sidebar" label="<?= __( 'Hide Sidebar' ) ?>" advance="true">
    	            <input type="checkbox" 
    	                class="lw-form-field js-switch"
    	                name="hide_sidebar"
