...
<head>
    ...
    <link href="{{ __yesset('dist/codemirror/lib/codemirror*.css') }}" rel="stylesheet">
...
<body ng-app="ManageApp" ng-controller="ManageController as manageCtrl">
    ...
    <div class="lw-store-header" style="background:#[[ manageCtrl.pageCSSStyles ]]"> 
       <a class="lw-show-process-action" href="<?=  route('home.page')  ?>"><img  class="logo-image" src="<?=  getStoreSettings('logo_image_url')  ?>" alt="" ></a>
    </div>
