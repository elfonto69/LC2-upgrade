    ...
    public function prepareProductList($categoryID = null, $brandId = null)
    {
        ...
        $requireColumns = [
            ...
            'detailPageURL' => function ($key) {
                return route('product.details', [$key['id'], slugIt($key['name'])]);
            },
   ...
   /* public function prepareDetailDialog($productID)
    {
        ...
        if (!empty($product->brands__id)) {
            ...
            // Create brand URL
               $brandData['brandURL'] = route('product.related.by.brand', [$brandData['_id'], slugIt($brandData['name'])]);
        }
        ...
        if (!empty($relatedProductsCollection)) {
            ...
            foreach ($relatedProductsCollection as $key => $relatedProduct) {
                ...
                $relatedProductsCollection[$key]['relatedProductURL'] = route('product.details', [$relatedProduct['id'], slugIt($relatedProduct['name'])]);
            }
    ...
    public function getName($productID)
    {
        ...
        return __engineReaction(1, [
                ...
                'detailsUrl'   => productsDetailsRoute($productData->id, slugIt($productData->name))
            ]);
    }
