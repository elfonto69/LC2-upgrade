        ...
        <!-- main heading -->
            ...
            <div class="lw-breadcrumb">
                ...
                <span ng-show="ProductListCtrl.categoryStatus">
                    ...
                    <!-- /third level -->
                    <span>
                    <a title="<?=  __('Back To Parent Category')  ?>"  class="lw-btn btn btn-default btn-xs pull-right" ui-sref="products({mCategoryID:ProductListCtrl.category.parent_id})" href><i class="fa fa-arrow-left"></i></a>
                    </span>
                </span>
                <!-- /main heading when child category or its product are selected -->
            ...
            <span ng-show="ProductListCtrl.categoryStatus">
                <div><h3><span ng-bind="ProductListCtrl.category.name"></span>
                    <a href ui-sref="categories.edit({catID:ProductListCtrl.category.id})" title="<?= __('Edit') ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil-square-o"></i> <?= __('Edit') ?></a><h3></div>
            </span>
            <!-- /main heading -->
