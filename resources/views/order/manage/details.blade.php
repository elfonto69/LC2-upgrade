<div ng-controller="ManageOrderDialogController as orderDialogCtrl" class="lw-dialog">
    <!-- main heading -->
   	<div class="lw-section-heading-block">
        <h3 class="lw-header"><?=  __( 'Order Details' )  ?> (<em ng-bind="orderDialogCtrl.order.orderUID"></em>)</h3>
    </div>
   <!-- /main heading -->
    ...
    <div class="table-responsive" ng-show="orderDialogCtrl.coupon">
    ...
    <div class="form-group lw-form-actions">
		...
		<button type="button" ng-click="orderDialogCtrl.close()" class="lw-btn btn btn-default pull-right" title="<?= __('Close') ?>"><?= __('Close') ?></button>
