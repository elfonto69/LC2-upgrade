...
<!-- userStatusColumnIdTemplate -->
    ...
    <% if(__tData.isTestOrder) { %>
        ...
        <a title="<?= __('Delete Sandbox Order') ?>" href="" ng-click="orderListCtrl.deleteSandBoxOrder('<%- __tData._id %>', 1, '<%- __tData.order_uid %>')" class="btn btn-danger btn-xs"><i class="fa fa-trash" aria-hidden="true"></i> <?= __('Delete') ?></a>
        <!-- Delete Sandbox Order button -->  

    <% } else { %>

        <!-- Delete Sandbox Order button -->
        <a title="<?= __('Delete Sandbox Order') ?>" href="" ng-click="orderListCtrl.deleteSandBoxOrder('<%- __tData._id %>', 2, '<%- __tData.order_uid %>')" class="btn btn-danger btn-xs"><i class="fa fa-trash" aria-hidden="true"></i> <?= __('Delete') ?></a>
        <!-- Delete Sandbox Order button -->  
