...
@endif
    ...
    <div ng-if="CartOrderCtrl.pageStatus == true">
		...
		novalidate>
			...
			<div class="table-responsive" ng-if="CartOrderCtrl.couponStatus == 1 && CartOrderCtrl.couponMessage == true">
							...
							<tbody class="ng-scope">
                                ...
                                <tr>
                                    ...
                                    <td class="lw-amount-td">
                                        + <span ng-bind="CartOrderCtrl.orderSupportData.formatedTotalTaxAmount"></span>
                                    </td> 
                                </tr> 
                                {{-- Total tax section --}} 
            ...
            <div class="panel panel-default lw-checkout-methods">
				...
				<div class="panel-body">
                    <lw-form-radio-field field-for="checkout_method" label="<?= __( 'Checkout Method' ) ?>">
                        ...
                        <span ng-if="CartOrderCtrl.orderSupportData.checkoutMethod.length != 0">
                           
    	                    <label ng-repeat="method in CartOrderCtrl.orderSupportData.checkoutMethod" class="radio-inline"> 
								
								<input ng-model="CartOrderCtrl.orderData.checkout_method" type="radio" name="checkout_method" ng-value="[[ method ]]" ng-change="CartOrderCtrl.checkValidDataForSubmit(CartOrderCtrl.orderData.checkout_method)" ng-required="true">
                                ...
                                <span ng-show="method == 6">
                                   <img alt="<?= __('Pay with Card') ?>" src="<?= url('resources/assets/imgs/stripe.jpg') ?>">
                                </span>
                                {{-- Stripe --}}
                        ...
                        <div class="alert alert-danger" ng-if="CartOrderCtrl.orderSupportData.checkoutMethod.length == 0">
                        	<?= __('No payment methods available, Please contact store administrator.') ?>
                        </div>
