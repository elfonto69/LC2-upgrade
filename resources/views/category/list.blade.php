	...
	<div class="lw-section-heading-block">
        <!-- main heading -->
	        ...
	        <span ng-show="!categoryCtrl.parentCategoryExist && !categoryCtrl.categoryStatus">
	        	<h3><?= __( 'Manage Categories & Products' ) ?></h3>
	        </span>
	        <!-- /main heading when parent are selected -->
            ...
            <div class="lw-breadcrumb">
                <span ng-show="categoryCtrl.parentCategoryExist">
                    ...
                    <span >
                       <a title="<?=  __('Back To Parent Category')  ?>"  class="lw-btn btn btn-default btn-xs pull-right" ui-sref="categories({mCategoryID:categoryCtrl.parentCategory.parent_id})" href><i class="fa fa-arrow-left"></i></a>
                    </span>
                    <!-- /Back to parent category button -->
                </span>
            </div>
            ...
            <span ng-show="categoryCtrl.parentCategoryExist">
                <div><h3><span ng-bind="categoryCtrl.parentCategory.name"></span><a href ui-sref="categories.edit({catID:categoryCtrl.parentCategory.id})" title="<?= __('Edit') ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil-square-o"></i> <?= __('Edit') ?></a></h3></div>
            </span>
		<!-- /main heading -->
    </div>
		...
		<div role="tabpanel" class="tab-pane fade in manageCategories active" id="manageCategories">
			...
			<div id="section1">
		    	...
		    	<!-- manage categories datatable header column name -->
					...
					<div class="alert alert-warning" ng-show="categoryCtrl.isInactiveParent"><?=  __("One of it's parent may be Inactive")  ?></div>
