        ...
        <div class="panel-heading lw-links-container">
            ...
            <ul class="nav custom-sidebar">
                    ...
                    <li>
                     ...
                     <li>
                        <a onclick="loadQuickOrder()" href="#." style="cursor:pointer" class="lw-item-link"   title="<?=  __('Quick Orders')  ?>"><i class="fa fa-money" ></i> 
                            <?=  __('Quick Orders')  ?>
                        </a>
                    </li>
...
{  //get_qucik_order  .col-xs-12
  $(".lw-component-content").load('/manage/report/fetch-quick-order-report');	
}
</script>