...
return [
    ...
    'images_dir'            => 'media-storage/upload-manager-assets/',
    'images_url'            => '/upload-manager-assets/',

    'files_dir'             => 'media-storage/upload-manager-assets/',
    'files_url'             => '/upload-manager-assets/',
