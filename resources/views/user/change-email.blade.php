<div ng-controller="UserChangeEmailController as changeEmailCtrl">
    ...
    <div class="alert alert-info" ng-if="changeEmailCtrl.changeEmail !== false && changeEmailCtrl.pageStatus">
        <?= __('You requested for change email __email__ on __humanRedableDate__ is pending. You can still requested for new one.', [
    ...
    <div ng-if="!changeEmailCtrl.activationRequired && changeEmailCtrl.requestSuccess">
        <div class="alert alert-success" role="alert"><strong><?=  __( 'Well done!' )  ?></strong> 
