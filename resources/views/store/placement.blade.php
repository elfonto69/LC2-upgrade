<div ng-controller="PlacementSettingsController as placementSettingsCtrl" class="col-lg-9">
	...
	<form class="lw-form lw-ng-form" 
        ...
        <div>
            <lw-form-field field-for="global_notification" label="<?= __('Website Notification') ?>" ng-if="placementSettingsCtrl.pageStatus"> 
                <div class="alert alert-info">
                    <?= __('The message you add here will be displayed on all the public pages below header.') ?>
                </div>
                <textarea 
        ...
        <div>
            <lw-form-field field-for="append_email_message" label="<?= __('Append Email Message') ?>" ng-if="placementSettingsCtrl.pageStatus"> 
             <div class="alert alert-info lw-alert-mini">
                <?= __('This Message will be inserted at end of email body content before the footer for every email send by the system. eg : Order Email , Activation email.') ?>
            </div>
                <textarea 
                    ...
                    rows="10" 
                    ng-minlength="6" 
                    ng-model="placementSettingsCtrl.editData.append_email_message" 
                    lw-ck-editor >
                    </textarea>
            </lw-form-field>
        </div>
