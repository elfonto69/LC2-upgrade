...
Route::group([
    ...
    Route::post('/add-quick-order', [
         'as'   => 'add-quick-order',
        'uses' => 'ProductController@addQuickOrder',
    ]);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::get('/fetch-quick-order-report', [
                'as'   => '',
                'uses' => 'ReportController@getQuickOrder',
            ]);
            
            
            Route::get('/fetch-quick-single-order/{id}', [
                'as'   => '',
                'uses' => 'ReportController@getSingleQuickOrder',
            ]);
            
                Route::post('/update-quick-order', [
            'uses' => 'ReportController@updateQuickOrder',
                ]);
    
            Route::get('/delete-quick-order/{id}', [
                'as'   => '',
                'uses' => 'ReportController@deleteQuickOrder',
            ]);
        ...
        Route::group([
            ...
            Route::post('/{paymentId}/delete-sandbox', [
                'as'   => 'order.payment.delete.sandbox',
