<div ng-controller="ManageUsersController as manageUsersCtrl">
    ...
    <a href="" ng-click="manageUsersCtrl.addNewUser()" title="<?=  __('Add New User')  ?>" class="lw-btn btn btn-default btn-sm pull-right"><i class="fa  fa-plus fa-lg"></i> <?=  __('Add New User') ?></a>
